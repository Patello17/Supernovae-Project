...
set_source(xstbabs.abs1*(xsvapec.v1)) # Fit APEC Model and Power Law for Contaminating Source
...
# Save Plot
print("Saving Plot...")
plt.savefig("2023ixf_mos1plot.pdf")
print("Plot Saved.")

# Save Data
print("Saving Data...")
save_all("results_mos1.log", clobber=True) # Saves everything except the flux
...
# Save flux to file
with open("results_mos1.log", "a") as f: # "a" appends the flux
        f.write("\n######### Calculated Fluxes\n\n")
