...
set_source(1, xstbabs.abs1*(xsvapec.v1+xsgaussian.g1)) # Fit APEC Model + Gaussian
set_source(2, xstbabs.abs1*(xsvapec.v1+xsgaussian.g1)) # Fit APEC Model + Gaussian
set_source(3, xstbabs.abs1*(xsvapec.v1+xsgaussian.g1)) # Fit APEC Model + Gaussian
