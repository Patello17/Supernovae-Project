...
set_source(xstbabs.abs1*(xsvapec.v1+xsgaussian.g1)+xstbabs.abs2*xspowerlaw.p1) # Fit APEC Model and Power Law for Contaminating Source
...
# Save Data
print("Saving Data...")
save_all("results_pn.log", clobber=True) # Saves everything except the flux
...
# Save flux to file
with open("results_pn.log", "a") as f: # "a" appends the flux
        f.write("\n######### Calculated Fluxes\n\n")
